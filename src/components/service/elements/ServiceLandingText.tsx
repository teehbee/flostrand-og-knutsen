...
const ServiceLandingText: React.FC<serviceHeroText> = ({ landingTitle, landingQuote, buttonText }) => {
  return (
    <div className="container text-start banner-content">
      <h1 className="text-light fs-2-125rem-to-3-625rem fw-bold text-shadow-dark">{landingTitle}</h1>
      <p className="text-light fs-1rem-to-1-25rem py-3 text-shadow-dark">{landingQuote}</p>
