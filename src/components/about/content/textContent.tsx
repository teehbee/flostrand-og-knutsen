...
export const aboutParagraph1Bold = "Det hele startet";
export const aboutParagraph1 = "med en manns umettelige nysgjerrighet og en brennende lidenskap for å skape. Marius Knutsen, grunnleggeren av Flostrand og Knutsen AS, har alltid hatt en evne til å se muligheter der andre ser hindringer.";

export const aboutParagraph2Bold = "Med en bakgrunn innen produktutvikling";
export const aboutParagraph2 = "og en dyp forståelse for metallarbeid, var det uunngåelig at Marius skulle starte sin egen bedrift. Etter å ha drevet sammen med sin far i flere år, overtok han verkstedet og kundene i ung alder. Det var en stor utfordring, men også en gyllen mulighet til å sette sitt eget preg på virksomheten.";
...
export const aboutParagraph5 =
  "har alltid vært å skape varige relasjoner med kunder ved å levere produkter og tjenester som overgår forventningene. Selv etter en periode med personlige utfordringer som førte til en midlertidig pause fra virksomheten, har hans dedikasjon til å hjelpe kunder med å finne de beste løsningene aldri sviktet. Med etableringen av Flostand og Knutsen AS i 2024, er vi tilbake for å fortsette å gi våre kunder den servicen og produktkvaliteten som vi er kjent for. Marius' tilbakekomst markerer begynnelsen på et nytt kapittel, hvor vi tar sikte på å utvide vårt tilbud og styrke vår posisjon i markedet.";

export const aboutParagraph6Bold = "Etter en periode med refleksjon og personlig vekst";
export const aboutParagraph6 = "og en etterspørsel fra tidligere kunder. føler jeg meg mer motivert enn noensinne til å fortsette å bygge opp denne bedriften. Jeg gleder meg til å ta fatt på nye utfordringer og skape enda flere innovative løsninger for våre kunder.";

export const aboutSignature = "- Marius Knutsen";
